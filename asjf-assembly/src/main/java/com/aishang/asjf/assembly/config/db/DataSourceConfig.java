package com.aishang.asjf.assembly.config.db;
...
@MapperScan(value = "com.aishang.asjf.dal.mapper", annotationClass = Mapper.class)
@PropertySources({
        ...
        @PropertySource("classpath:config/${spring.profiles.active}/sub-applications.properties"),
        @PropertySource(value = "classpath:config/${spring.profiles.active}/sms-template.properties", encoding="utf-8")
})
@ComponentScans(
        value = {
                @ComponentScan("com.aishang.asjf.adapter.impl"),
                @ComponentScan("com.aishang.asjf.client"),
                @ComponentScan("com.aishang.asjf.common")
        })
@EnableCaching
...
public class DataSourceConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactory() throws Exception {
        ...
        sessionFactory.setTypeAliasesPackage("com.aishang.asjf.dal.model");
