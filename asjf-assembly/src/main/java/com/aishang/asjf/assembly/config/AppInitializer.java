package com.aishang.asjf.assembly.config;
...
import com.aishang.asjf.assembly.config.redis.RedisConfig;
import com.aishang.asjf.assembly.config.security.SecurityConfig;
...
//        return new Class[]{DataSourceConfig.class, DubboConfig.class, SecurityConfig.class};
        return new Class[]{DataSourceConfig.class, RedisConfig.class, SecurityConfig.class};
