package com.aishang.asjf.swagger;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).produces(headers).consumes(headers).apiInfo(apiInfo())
                ...
                .apis(RequestHandlerSelectors.basePackage("com.aishang.asjf.web.controller")).paths(PathSelectors.any()).build();
    }

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("爱尚金服系统 RESTful API").termsOfServiceUrl("")
