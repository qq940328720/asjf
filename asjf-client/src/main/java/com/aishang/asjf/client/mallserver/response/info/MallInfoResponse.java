...
public class MallInfoResponse implements Serializable {
    ...
    public void setCommodityPriceMarket(BigDecimal commodityPriceMarket) {
        if (null == commodityPriceMarket) {
            commodityPriceMarket = new BigDecimal(0);
        }
    ...
    public void setCommodityPriceCost(BigDecimal commodityPriceCost) {
        if (null == commodityPriceCost) {
            commodityPriceCost = new BigDecimal(0);
        }
    ...
    public boolean equals(Object o) {
        ...
        MallInfoResponse that = (MallInfoResponse) o;
