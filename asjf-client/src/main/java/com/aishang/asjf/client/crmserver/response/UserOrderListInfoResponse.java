...
public class UserOrderListInfoResponse implements Serializable{
    ...
    public boolean equals(Object o) {
        ...
        UserOrderListInfoResponse that = (UserOrderListInfoResponse) o;
    ...
    public String toString() {
        return "UserOrderListInfoResponse{" +
                "orderCode='" + orderCode + '\'' +
