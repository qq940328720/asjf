...
public class SaveUserBankRequest {
    ...
    public boolean equals(Object o) {
        ...
        SaveUserBankRequest that = (SaveUserBankRequest) o;
        ...
        if (bankCardImgUrl != null ? !bankCardImgUrl.equals(that.bankCardImgUrl) : that.bankCardImgUrl != null)
            return false;
        return bankPhone != null ? bankPhone.equals(that.bankPhone) : that.bankPhone == null;
    }
